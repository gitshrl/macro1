...
from macro1.utils.logger import setup_logger
from macro1.schema.schema import AgentState
from macro1 import Environment, VLMWrapper, Agent


load_dotenv()
setup_logger(name='macro1')
logger = logging.getLogger('macro1')
...
def build_agent_ui_demo():
    with gr.Blocks(title="Macro1 WebUI") as demo:
        with gr.Row():
            gr.Markdown(
                """
                # 📱 Macro1 WebUI
